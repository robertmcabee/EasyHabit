    ...
    return (
      <div className='max-w-[10rem] min-w-[5rem] w-full text-center'>
        ...
        <div className="flex justify-center">
          <div className='flex justify-center shadow-lg align-middle p-2 h-10 w-14 opacity-80 hover:opacity-100 hover:w-full hover:text-white hover:bg-black rounded-full cursor-pointer group max-w-[5rem] --slow-transition'>
