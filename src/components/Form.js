...
class Form extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <section className='bg-white p-10 m-10 rounded-xl w-96 absolute z-50 top-0 drop-shadow-2xl animate-dropin'>
            ...
            <form onSubmit={this.handleSubmit} className="flex flex-col">
              <fieldset>
                ...
                <input type="text" name="name" autoComplete="off" value={this.state.name} onChange={this.handleChange} placeholder="e.g. 'Stretch'" className="placeholder:italic placeholder:text-neutral-400 h-8 rounded-lg bg-neutral-100 p-4 m-4"/>
            ...
            <input value="Create" type="submit" className="bg-black text-white font-bold rounded-md p-3 mt-4" style={{color: this.state.color}}/>
          </form>
        </section>
